...
if (! (str side _unit isEqualTo "LOGIC") ) then {
	[
		_unit,
		briefingName,
		3,
...
hint parseText (
	...
	"<br/><t align='left'>Who Can Revive?:</t><t align='right'>Medkit-havers only!</t>" +
	"<br/><t align='left'>First-Aid Kit required?:</t><t align='right'>No</t>" +
	"<br/><t align='left'>Consume First-Aid Kit?</t><t align='right'>No</t>" +
	"<br/><t align='left'>On Death:</t><t align='right'>Wave respawn (1 min)</t>" +
