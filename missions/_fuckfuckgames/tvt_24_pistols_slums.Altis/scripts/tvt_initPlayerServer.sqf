...
//*** Necessary to implement the TDM rule set as defined by initTDMRules.sqf!
waitUntil { !isNil "sxf_TDM_handlePlayerEntry" };
_unit call sxf_TDM_handlePlayerEntry;



//*** Implement the paradrop functionality if needed
