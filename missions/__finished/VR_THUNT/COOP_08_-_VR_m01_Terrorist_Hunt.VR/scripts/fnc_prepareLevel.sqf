//CONTEXT: server-side
if (roundInProgress && !activateAO) exitWith {hint "ERROR -- fnc_prepareLevel.sqf was somehow called while a round was already in progress or activateAO was already set!";};
