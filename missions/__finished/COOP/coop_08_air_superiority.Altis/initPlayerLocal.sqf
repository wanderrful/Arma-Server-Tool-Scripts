...
player addAction [
	"<t color='#30C330' shadow='2'>Bypass the Jets DLC and get in!</t>",
	{
		player moveInDriver cursorObject;
	},
	nil, 1.5, true, true, "", //default values
	"cursorObject isKindOf 'Plane' && {!((vehicle player) isKindOf 'Plane') && {!(601670 in (getDLCs 1))}}" //condition
];
