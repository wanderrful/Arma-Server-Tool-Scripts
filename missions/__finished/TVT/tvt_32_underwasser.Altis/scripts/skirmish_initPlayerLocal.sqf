...
hint parseText (
	"<br/><t size='1.5' color='#E28014' align='center'>Underwassser</t>" +
	"<br/>by sixtyfour<br/>" +
	"<br/><br/>" +
	"<br/>Mission Settings:" +
	...
	"<br/><t align='left'>Bleed Out Duration:</t><t align='right'>2 minutes</t>" +
	"<br/><t align='left'>Revive Duration:</t><t align='right'>6 seconds</t>" +
